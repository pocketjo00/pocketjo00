...
public class UserNameRecognizer {
	 ...
	 * @version 1.02		2025-01-18  Changed code so that the first character is alphabetic instead of alphanumeric
	 *                                  and allowed use of minus sign and underscores along with period as 
	 *                                  special characters.
	 * @version 1.03        2025-01-21  Rephrased line 82.
	 */
	...
	public static String checkForValidUserName(String input) {
		...
		while (running) {
			...
			case 1: 
				...
				// . , - , _ -> State 2
				else if (currentChar == '.' || currentChar == '-' || currentChar == '_') { // Check for special characters (. , - , _) 
					nextState = 2;
