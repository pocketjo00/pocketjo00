...
public class PasswordRecognizer {
	 ...
	 * 
	 * @version 0.01        2025-01-26  Updated Password Requirements
	 */
	...
	public static boolean foundUpperCase = false;		// Boolean flag for finding upper case character
	public static boolean foundLowerCase = false;       // Boolean flag for finding lower case character
	public static boolean foundNumericDigit = false;    // Boolean flag for finding numeric digit character
	public static boolean foundSpecialChar = false;     // Boolean flag for finding special character
	public static boolean foundOtherChar = false;       // Boolean flag for finding other character
	public static boolean foundLongEnough = false;      // Boolean flag for the length of the password
	...
	public static String evaluatePassword(String input) {
		...
		while (running) {
			...
			if (currentChar >= 'A' && currentChar <= 'Z') {
				...
				System.out.println("Other character found, account setup has terminated");
				passwordIndexofError = currentCharNdx;
				foundOtherChar = true;
				running = false;
				return "*** Error *** An invalid character '" + currentChar + "' has been found in the password!";
			}
			if (currentCharNdx >= 7) {
